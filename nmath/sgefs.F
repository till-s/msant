...
* Fullsource for module SGEFS from package CMLIB.
* Retrieved from CAMSUN on Mon Jun  2 09:07:56 1997.
* ======================================================================
...
C                 (SIAM) DATED 1979.
c	no calls to xerror,xerrwv
C***ROUTINES CALLED  R1MACH,SGECO,SGESL,
