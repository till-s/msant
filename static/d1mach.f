...
c
c      data small(1),small(2) / bash0000000,  bash0100000 /
c      data large(1),large(2) / ,  fefffff /
c      data right(1),right(2) / bash0000000,  ca00000 /
c      data diver(1),diver(2) / bash0000000,  cb00000 /
c      data log10(1),log10(2) / 09f79ff,  fd34413 /, sc/987/
c
